...
/**
     * @ORM\ManyToMany(targetEntity=Plat::class, inversedBy="favoritedBy")
     */
    private $favoritedPlats;

    public function __construct()
    {
        $this->favoritedPlats = new ArrayCollection();
    }

    /**
     * @return Collection|Plat[]
     */
    public function getFavoritedPlats(): Collection
    {
        return $this->favoritedPlats;
    }
}
