...
public function getUserImage(string $imageName): Response
{
    ...
    public function favorites(EntityManagerInterface $entityManager): Response
    {
        ...
        $queryBuilder
            ...
            ->setParameter('userId', $currentUser->getUserIdentifier());
...
public function new(Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        // Handle file upload
       /* $uploadedFile = $form->get('photop')->getData();
        ...
        // Set the photo path to the entity
        $plat->setPhotop($fileName);*/


 $imageFile = $form['photop']->getData();
